...
//\n\
//The struggle began one Sunday night at 3am. With most students and faculty sleeping, the Spartans struck, taking over the Duderstadt Center with Spartan speed - their goal? To destroy the EECS 404 autograder and ruin the new game engine course!\n\
//\n\
//Fortunately, you (p) were working on homework late into the night in the VisStudio. When the spartans (s) burst through the lab door, you quickly grabbed the autograder (a raspberry pie 4) from the front desk and hid beneath a table as the lights went out. Despite your late-night fatigue, you begin feeling your way past the walls (b) and through the halls. Can you escape, or will the Michigan gamedev program crash and burn?\n\
//\n\
//G A M E - S T A R T";
//
//const std::string game_over_bad_message = "Exhausted by the chase, darkness begins to swirl around you.\n\
//\n\
...
//};
//
//const int HARDCODED_VIEW_WIDTH = 13;
//const int HARDCODED_VIEW_HEIGHT = 9;
//const int HARDCODED_VIEW_WIDTH_HALF = 6;
//const int HARDCODED_VIEW_HEIGHT_HALF = 4;
//
